...
- <span style={{color: '#26bbae'}}>STRING_TO_LEFT_EDITOR</span> (<span style={{color: '#f9a156'}}>&lt;string&gt;</span>) - set left editor value
    - <span style={{color: '#26bbae'}}>LEFT_EDITOR_TO_STRING</span> () - return value from left editor as string
- <span style={{color: '#26bbae'}}>STRING_TO_RIGHT_EDITOR</span> (<span style={{color: '#f9a156'}}>&lt;string&gt;</span>) - set right editor value
    - <span style={{color: '#26bbae'}}>RIGHT_EDITOR_TO_STRING</span> () - return value from right editor as string
