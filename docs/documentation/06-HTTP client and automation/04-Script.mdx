...
import Func from '@site/src/components/Func';
import Param from '@site/src/components/Param';

- <Func>VARS</Func>.<Param>variable name</Param> - set programmatically global variable, see the tab "HTTP variables"
- <Func>CONSOLE</Func> (<Param>text or JSON</Param>) - print text or JSON on console box
- <Func>ERROR</Func> (<Param>error message</Param>) - print error message on console box
...
- <details>
        <summary>
            <Func>REQ</Func> (
                <Param>request description</Param>,
                optional: <Param>request body: string</Param>
            ) - send programmatically HTTP request, see the tab "HTTP requests"
        </summary>
...
- <details>
        <summary>
            <Func>BEFORE_REQ</Func> (
                <Param>request description</Param>,
                <Param>function(requestObject) &#123; ... &#125;</Param>
...
- <details>
        <summary>
            ...
            ) - select/find value from json, or make the new json based on JSON parameter using **Jsonata** language
        </summary>
