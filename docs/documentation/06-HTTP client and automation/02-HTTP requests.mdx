...
- <span style={{color: '#26bbae'}}>body</span>, This is the textual content, for example, in JSON format.<br></br>
...
<br></br><span style={{color: '#cccccc'}}>//comments</span>
...
<br></br><span style={{color: '#aaaaaa'}}>## Name of the request group</span>
