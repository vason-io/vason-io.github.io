...
- <Func>GET_OUTPUT_DOM_SELECTOR</Func>() - get selector from the output
  DOM-Element to interact with user interface using Javascript API in Python.
  See example below:
...
# get HTML element
outputElement = document.querySelector(GET_OUTPUT_DOM_SELECTOR())
